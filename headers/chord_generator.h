...
public:
	...
	//Accessors
	Chord* getMajorTriadChord(std::string root_note);		//returns a major triad chord with the given root note
	Chord* getMinorTriadChord(std::string root_note);		//returns a minor triad chord with the given root note
